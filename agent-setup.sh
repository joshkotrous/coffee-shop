...
echo ""
echo "🎯 To test the setup, use your configured admin credentials to login via the API or UI."
echo "   Refer to your environment configuration or admin setup documentation."
echo ""
