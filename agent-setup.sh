...
echo ""
echo "👤 Default admin credentials are set securely and not displayed for security reasons."
echo "🎯 To test the setup, use your configured admin credentials to login."
echo "   For example, use the API endpoint POST /api/auth/login with your admin email and password."
