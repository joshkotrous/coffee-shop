...
echo ""
echo "⚠️  IMPORTANT: Default admin credentials are not displayed for security reasons."
echo "    Please ensure to set secure admin credentials during initial setup or via your environment configuration."
echo ""
