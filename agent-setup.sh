...
echo ""
echo "👤 Default admin credentials are not displayed for security reasons."
echo "   Please set your admin credentials securely in the application configuration."
echo ""
echo "🎯 To test the setup, use your configured admin credentials to authenticate."
echo "   Example curl commands are omitted to avoid exposing sensitive information."
echo ""
