...
echo ""
echo "👤 Default admin credentials are set but not displayed for security reasons."
echo "🎯 To test the setup, use your configured admin credentials to authenticate."
echo "   For example, use the login API endpoint with your admin email and password."
